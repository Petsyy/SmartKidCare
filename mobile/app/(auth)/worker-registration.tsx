  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50" edges={['top']}>
      ...
      >
        ...
        >
          {/* HEADER CARD */}
          <View className="mx-5 rounded-3xl overflow-hidden shadow-lg shadow-blue-300">
            <LinearGradient
            ...
            <View className="bg-white rounded-3xl p-6 shadow-lg shadow-gray-200">
              ...
              <FormField label="Password" required icon={Lock}>
                <View className="relative">
                  <TextInput
                    className='px-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-base text-gray-900 pr-12 focus:border-blue-500 focus:bg-white'
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <View className={`w-5 h-5 border-2 ${isChecked ? 'bg-blue-500 border-blue-500' : 'border-gray-300 bg-white'} rounded mr-3 items-center justify-center flex-shrink-0`}>
                  {isChecked && (
