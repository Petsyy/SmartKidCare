...
export default function ViewFeedingDetails() {
    ...
    const getStatusColor = (status: FeedingStatus) => {
        switch (status) {
            ...
            case 'Missed': return 'bg-purple-500';
        ...
        <View className="flex-1 bg-gray-50">
            ...
            >
                ...
                <View className="mb-6">
                    ...
                    <Text className="text-base text-gray-500 mt-1">View your child's daily feeding records</Text>
                </View>
                ...
                <View className="bg-white rounded-xl p-5 mb-6 border border-gray-200">
                    ...
                    <View className="mt-6 pt-4 border-t border-gray-100">
                        <View className="flex-row items-center justify-between mb-2">
                            <Text className="text-base font-medium text-gray-700">Overall Feeding Rate</Text>
                            <Text className="text-2xl font-bold text-green-600">{feedingRate}%</Text>
                        </View>
