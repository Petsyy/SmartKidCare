    ...
    <Tabs screenOptions={getTabBarScreenOptions(bottomInset)}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Notifications",
          tabBarIcon: ({ color, focused }) => (
            <Bell color={color} size={focused ? 22 : 20} strokeWidth={focused ? 2.4 : 2} />
          ),
        }}
      />
      <Tabs.Screen
      ...
      <Tabs.Screen name="parent-view-record" options={{ href: null, tabBarStyle: { display: "none" } }} />
      <Tabs.Screen name="parent-child-details" options={{ href: null, tabBarStyle: { display: "none" } }} />
    </Tabs>
    </ParentGate>
    {loading ? (
